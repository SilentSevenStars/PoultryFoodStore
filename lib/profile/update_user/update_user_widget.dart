  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final updateUserUserRecord = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Stack(
                children: [
                  if ((updateUserUserRecord != null) && loggedIn)
                    Form(
                      key: _model.formKey,
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller: _model.nameTextController ??=
                                        ...
                                        text: updateUserUserRecord.name,
                                      ),
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller: _model.emailTextController ??=
                                          TextEditingController(
                                        text: updateUserUserRecord.email,
                                      ),
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.addressTextController ??=
                                              TextEditingController(
                                        text: updateUserUserRecord.address,
                                      ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  dateTimeFormat(
                                      "yMd", updateUserUserRecord.birthday!),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Inter',
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await widget.user!
                                    ...
                                    birthday: _model.datePicked ?? updateUserUserRecord.birthday,
