  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ProductRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final productDescriptionProductRecord = snapshot.data!;
              ...
              child: Stack(
                children: [
                  if ((widget.product != null) &&
                      (productDescriptionProductRecord != null))
                    Align(
                      alignment: const AlignmentDirectional(0.0, 0.0),
                      child: StreamBuilder<CategoryRecord>(
                        stream: CategoryRecord.getDocument(
                            productDescriptionProductRecord.categoryRef!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                            ...
                            children: [
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) =>
                                        StreamBuilder<RoleRecord>(
                                      stream: RoleRecord.getDocument(
                                          currentUserDocument!.roleRef!),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
                                          return Center(
                                        ...
                                        final rowRoleRecord = snapshot.data!;
                              ...
                              Row(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.network(
                                      productDescriptionProductRecord.photoUrl,
                                      width: 200.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    20.0, 0.0, 20.0, 0.0),
                                child: Text(
                                  productDescriptionProductRecord.productName,
                              ...
                              Padding(
                                ...
                                child: Stack(
                                  children: [
                                    Text(
                                      'Category: ${columnCategoryRecord.name}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Inter',
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      'Brand: ${productDescriptionProductRecord.brand}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Inter',
                                    ...
                                    Text(
                                      ' ₱${productDescriptionProductRecord.price.toString()}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Inter',
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    20.0, 0.0, 20.0, 0.0),
                                child: Text(
                                  productDescriptionProductRecord.description,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Inter',
                                    ...
                                    child: StreamBuilder<List<ProductRecord>>(
                                      stream: queryProductRecord(
                                        queryBuilder: (productRecord) =>
                                          ...
                                          'category_ref',
                                          isEqualTo:
                                              productDescriptionProductRecord
                                                  .categoryRef,
                                        ),
                                      ),
                                      builder: (context, snapshot) {
