...
class _CreateProductWidgetState extends State<CreateProductWidget> {
  ...
  void initState() {
    ...
    _model.productBrandTextController ??= TextEditingController();
    _model.productBrandFocusNode ??= FocusNode();
                      ...
                      children: [
                        Expanded(
                          child: SizedBox(
                            width: double.infinity,
                            child: TextFormField(
                              controller: _model.productBrandTextController,
                              focusNode: _model.productBrandFocusNode,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                isDense: true,
                                ...
                                hintText: 'Enter Product brand here..',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Inter',
                              ...
                              cursorColor:
                                  FlutterFlowTheme.of(context).primaryText,
                              validator: _model
                                  .productBrandTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                          ...
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: 'Enter the product here..',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Inter',
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              await productRecordReference
                                ...
                                brand: _model.productBrandTextController.text,
                                description:
                                ...
                                categoryRef: functions.getDocIDbyCategoryID(
                                    _model.categoryValue!),
                              ...
                              _model.product =
                                  ProductRecord.getDocumentFromData(
                                      createProductRecordData(
                                        ...
                                        brand: _model
                                            .productBrandTextController.text,
                                        description: _model
                              ...
                              await _model.product!.reference
                                  .update(createProductRecordData(
                                productID: _model.product?.reference.id,
                              ));
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content:
                                          const Text('Upload a picture for product'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
