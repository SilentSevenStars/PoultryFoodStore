                  ...
                  children: [
                            ...
                            child: SizedBox(
                              ...
                              child: Autocomplete<String>(
                                ...
                                optionsBuilder: (textEditingValue) {
                                  ...
                                  return productPageProductRecordList
                                      .map((e) => e.productName)
                                      .toList()
                                      .where((option) {
                                ...
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    'product': serializeParam(
                                      functions.getDocIDbyProduct(_model.scan),
                    ...
                    if (!FFAppState().searchIsActive)
                      Builder(
                        builder: (context) {
                          final productList =
                              productPageProductRecordList.toList();
