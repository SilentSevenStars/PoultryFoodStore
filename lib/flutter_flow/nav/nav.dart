...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'UserCrud',
          path: '/userCrud',
          builder: (context, params) => UserCrudWidget(
            uploadPicture: params.getParam(
              'uploadPicture',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'ItemListPage',
          path: '/itemListPage',
          builder: (context, params) => ItemListPageWidget(
            order: params.getParam(
              'order',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'ItemSold',
          path: '/itemSold',
          builder: (context, params) => ItemSoldWidget(
            order: params.getParam(
              'order',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'AddStockHistory',
          path: '/addStockHistory',
          builder: (context, params) => const AddStockHistoryWidget(),
        ),
        FFRoute(
          name: 'AddStockCart',
          path: '/addStockCart',
          builder: (context, params) => AddStockCartWidget(
            addStock: params.getParam(
              'addStock',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['AddStock'],
            ),
          ),
        ),
        FFRoute(
          name: 'StocktemList',
          path: '/stocktemList',
          builder: (context, params) => StocktemListWidget(
            addStock: params.getParam(
              'addStock',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'Expense',
          path: '/expense',
          builder: (context, params) => ExpenseWidget(
            addStock: params.getParam(
              'addStock',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'AddStockList',
          path: '/addStockList',
          builder: (context, params) => AddStockListWidget(
            addStock: params.getParam(
              'addStock',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'Supplier',
          path: '/supplier',
          builder: (context, params) => const SupplierWidget(),
        ),
        FFRoute(
          name: 'SupplierInformation',
          path: '/supplierInformation',
          builder: (context, params) => SupplierInformationWidget(
            supplier: params.getParam(
              'supplier',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['Supplier'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'addSupplier',
          path: '/addSupplier',
          builder: (context, params) => const AddSupplierWidget(),
        ),
        FFRoute(
          name: 'editSupplier',
          path: '/editSupplier',
          builder: (context, params) => EditSupplierWidget(
            supplier: params.getParam(
              'supplier',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'SendLink',
          path: '/sendLink',
          builder: (context, params) => const SendLinkWidget(),
        )
