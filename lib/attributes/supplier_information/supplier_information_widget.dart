...
import 'supplier_information_model.dart';
export 'supplier_information_model.dart';

class SupplierInformationWidget extends StatefulWidget {
  const SupplierInformationWidget({
    super.key,
...
class _SupplierInformationWidgetState extends State<SupplierInformationWidget> {
  late SupplierInformationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SupplierInformationModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<SupplierRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final supplierInformationSupplierRecord = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Stack(
                children: [
                  if ((supplierInformationSupplierRecord != null) &&
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Image.network(
                            supplierInformationSupplierRecord.photoUrl,
                            fit: BoxFit.cover,
                          ),
                        ),
                        Padding(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    supplierInformationSupplierRecord
                                        .supplierName,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                  ...
                                  Text(
                                    supplierInformationSupplierRecord.address,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
                                  ...
                                  Text(
                                    supplierInformationSupplierRecord.email,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
