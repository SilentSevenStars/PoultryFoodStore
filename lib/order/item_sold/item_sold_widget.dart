...
import 'item_sold_model.dart';
export 'item_sold_model.dart';

class ItemSoldWidget extends StatefulWidget {
  const ItemSoldWidget({
    super.key,
    required this.order,
  ...
  @override
  State<ItemSoldWidget> createState() => _ItemSoldWidgetState();
}

class _ItemSoldWidgetState extends State<ItemSoldWidget> {
  late ItemSoldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemSoldModel());
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                                    ...
                                                    children: [
                                                      ...
                                                      StreamBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          final categoryTxtCategoryRecord =
                                                              snapshot.data!;

                                                          return Text(
                                                            categoryTxtCategoryRecord
                                                                .name,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    'Total: ₱${listViewItemListRecord.subTotalPrice.toString()}',
                                                  ...
                                                  Text(
                                                    'Quantity: ${listViewItemListRecord.quantity.toString()}',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
