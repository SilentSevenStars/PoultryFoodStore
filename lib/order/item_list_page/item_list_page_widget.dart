...
import '/component/quantity/quantity_widget.dart';
...
import 'item_list_page_model.dart';
export 'item_list_page_model.dart';

class ItemListPageWidget extends StatefulWidget {
  const ItemListPageWidget({
    super.key,
    required this.order,
  });
  ...
  @override
  State<ItemListPageWidget> createState() => _ItemListPageWidgetState();
}

class _ItemListPageWidgetState extends State<ItemListPageWidget> {
  late ItemListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemListPageModel());
    ...
    return StreamBuilder<List<ProductRecord>>(
      stream: queryProductRecord(
        queryBuilder: (productRecord) => productRecord.where(
          'stock',
          isGreaterThan: FFAppState().stockZero,
        ),
      ),
            ...
            body: SafeArea(
              ...
              child: StreamBuilder<OrderRecord>(
                ...
                builder: (context, snapshot) {
                  ...
                  final stackOrderRecord = snapshot.data!;

                  return Stack(
                    children: [
                      if ((widget.order != null) && (stackOrderRecord != null))
                            ...
                            children: [
                                  ...
                                  children: [
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Autocomplete<String>(
                                          ...
                                          optionsBuilder: (textEditingValue) {
                                            ...
                                            return itemListPageProductRecordList
                                                .map((e) => e.productName)
                                                .toList()
                                                .where((option) {
                                    ...
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        _model.product =
                                            await actions.getProductByScan(
                                          _model.scan,
                                        );
                                        if (_model.product!) {
                              ...
                              if (!FFAppState().searchIsActive)
                                Builder(
                                  builder: (context) {
                                    final productList =
                                        itemListPageProductRecordList.toList();
