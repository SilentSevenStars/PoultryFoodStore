...
class _PaymentPageWidgetState extends State<PaymentPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ItemListRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ItemListRecord> paymentPageItemListRecordList = snapshot.data!;
                                  ...
                                  StreamBuilder<List<ItemListRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.separated(
                                        ...
                                        itemCount:
                                            listViewItemListRecordList.length,
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              if (_model.paymentTextController
                                                          .text !=
                                                      '')
                                                Text(
                                                  (functions.convertStr(_model
                                                              .paymentTextController
                                                              .text) -
                                                          (widget.totalPrice!))
                                                      .toString(),
